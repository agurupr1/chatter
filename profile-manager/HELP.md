...
* The original package name 'io.chatter.profile-manager' is invalid and this project uses 'io.chatter.profile_manager' instead.
...
* [Flyway Migration](https://docs.spring.io/spring-boot/3.3.7/how-to/data-initialization.html#howto.data-initialization.migration-tool.flyway)
